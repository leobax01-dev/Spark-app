...
var PostHogConversations = /** @class */ (function () {
    ...
    PostHogConversations.prototype.onRemoteConfig = function (result) {
        ...
        var conversations = result.config['conversations'];
    ...
    PostHogConversations.prototype.loadIfEnabled = function () {
        ...
        if ((0, general_utils_1.isToolbarInstance)(this._instance.config)) {
            return;
        }
