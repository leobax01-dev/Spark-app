...
var WebVitalsAutocapture = /** @class */ (function () {
    ...
    WebVitalsAutocapture.prototype._loadScript = function (cb) {
        var _a, _b, _c;
        if ((_a = globals_2.assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.postHogWebVitalsCallbacks) {
            // already loaded
            cb();
            return;
        }
        var kind = this.useAttribution ? 'web-vitals-with-attribution' : 'web-vitals';
        (_c = (_b = globals_2.assignableWindow.__PosthogExtensions__) === null || _b === void 0 ? void 0 : _b.loadExternalDependency) === null || _c === void 0 ? void 0 : _c.call(_b, this._instance, kind, function (err) {
            if (err) {
