...
var PostHogFeatureFlags = /** @class */ (function () {
    ...
    PostHogFeatureFlags.prototype._callFlagsEndpoint = function (options) {
        ...
        var data = {
            ...
            person_properties: __assign(__assign(__assign({}, (((_a = this._persistence) === null || _a === void 0 ? void 0 : _a.get_initial_props()) || {})), (this._prop(constants_1.STORED_PERSON_PROPERTIES_KEY) || {})), { $lib: config_1.default.LIB_NAME, $lib_version: config_1.default.LIB_VERSION }),
    ...
    PostHogFeatureFlags.prototype.getFeatureFlagResult = function (key, options) {
        ...
        if (options.send_event || !('send_event' in options)) {
            if (!(key in flagCallReported) || !flagCallReported[key].includes(flagReportValue)) {
                ...
                if (!(0, core_1.isUndefined)((_k = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.metadata) === null || _k === void 0 ? void 0 : _k.has_experiment)) {
                    properties.$feature_flag_has_experiment = flagDetails.metadata.has_experiment;
                }
                if (!(0, core_1.isUndefined)((_l = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.metadata) === null || _l === void 0 ? void 0 : _l.version)) {
                    properties.$feature_flag_version = flagDetails.metadata.version;
                }
                var reason = (_o = (_m = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.reason) === null || _m === void 0 ? void 0 : _m.description) !== null && _o !== void 0 ? _o : (_p = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.reason) === null || _p === void 0 ? void 0 : _p.code;
                if (reason) {
                    properties.$feature_flag_reason = reason;
                }
                if ((_q = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.metadata) === null || _q === void 0 ? void 0 : _q.id) {
                ...
                if ((_r = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.metadata) === null || _r === void 0 ? void 0 : _r.original_payload) {
                    properties.$feature_flag_original_payload = (_s = flagDetails === null || flagDetails === void 0 ? void 0 : flagDetails.metadata) === null || _s === void 0 ? void 0 : _s.original_payload;
                }
                if (errors.length) {
