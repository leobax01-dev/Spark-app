    ...
    RateLimiter.prototype.clientRateLimitContext = function (checkOnly) {
        ...
        if (isRateLimited && !this.lastEventRateLimited && !checkOnly) {
            this.instance.capture(RATE_LIMIT_EVENT, {
                $$client_ingestion_warning_message: "posthog-js client rate limited. Config is set to ".concat(captureEventsPerSecond, " events per second and ").concat(captureEventsBurstLimit, " events burst limit."),
            }, {
