...
function MainApp({user,onLogout}){
  ...
  const FULL_BLEED_TAB_IDS = [...OPERATIONS_TAB_IDS, "autopilot", "transactions"];
  const NAV=isBroker ? [
          ...
          {FULL_BLEED_TAB_IDS.includes(tab)?(
            ...
            <div style={{flex:1,overflowY:"auto",WebkitOverflowScrolling:"touch",
              ...
              <div style={{maxWidth:"100%"}}>
                ...
                {tab==="clients"&&<ErrorBoundary label="Clients"><ClientPanel user={user} planKey={planKey} isMobile={isMobile}/></ErrorBoundary>}{tab==="market"&&<ErrorBoundary label="Market"><MarketPanel user={user} planKey={planKey} isMobile={isMobile}/></ErrorBoundary>}{tab==="calculator"&&<ErrorBoundary label="Calculator"><CommissionCalculator user={user} planKey={planKey}/></ErrorBoundary>}{tab==="team"&&<ErrorBoundary label="Team Settings"><BrokerTeamSettings user={user}/></ErrorBoundary>}
              </div>
            </div>
          )}
          <MobileNav/>
